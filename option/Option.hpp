#ifndef _shabang_option_option_hpp_
#define _shabang_option_option_hpp_
...
public:
  ...
  ref_t get_or_insert_default() {
    static_assert(
        !std::is_reference<opt_t>::value,
        "Option::get_or_insert_default() is not available for reference types");
    if (is_some())
      return m_storage.ref();
    m_storage = Storage(T());
    return m_storage.ref();
...
#endif //_shabang_option_option_hpp_
